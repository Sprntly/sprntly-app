 ...
 *   3 "Composing your first Top Insights brief"
...
const STAGES = [
  ...
  {
    label: "Composing your first Top Insights brief",
...
export function FirstBrief() {
  ...
  const runGeneration = useCallback(async () => {
    ...
    try {
      ...
      if (brief) {
        ...
        setPhase({
          kind: "failed",
          error: "Brief is still processing. Enter Sprntly and check Top Insights in a few minutes.",
        })
      }
    } catch (e) {
      setPhase({
  ...
  const subtitle =
    phase.kind === "ready"
      ...
      : phase.kind === "failed"
        ...
        : "Your coworkers are reading everything you shared and composing your first Top Insights brief. It'll be waiting on your Brief page — this usually takes one to two minutes."
  ...
  // The Top Insights brief is sent Monday 06:00 in the company owner's timezone
  // (backend: brief_schedule.should_run_brief / resolve_user_timezone),
    ...
    >
      ...
      {phase.kind === "ready" && (
        <div className="gen-ready">
          ...
          <div>
            <div className="t">Your Top Insights are waiting</div>
            <div className="s">
