...
//
// Container-level mount test for onboarding step 06 — "Connect your tools."
// Mounts the real default container under jsdom with mocked
// auth/onboarding/router/api so a render-time throw is caught — the
...
describe("Onboarding6 (container) — mounts without crashing", () => {
