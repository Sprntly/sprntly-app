...
const MOCK_CHATS: ConversationRow[] = [
  {
    ...
    savedTurn: { query: "Three signals — Day-30 retention dip in 4 deployments, Cerner deal stalled in security review, care plan co-authoring up 12% WoW.", reply: "" },
  },
  {
    id: "today-1",
    title: "On-call · CarePlan compose latency spike",
    time: new Date(Date.now() - 7200000).toISOString(),
    savedTurn: { query: "SEV-2 active · Sentry + Datadog confluence triggered · 11 Riverside users affected, p99 7.4s.", reply: "" },
  },
  {
    id: "today-2",
    title: "Day-30 cohort breakdown by EHR vendor",
    time: new Date(Date.now() - 10800000).toISOString(),
    savedTurn: { query: "DS Agent ran a cross-segment analysis — Epic deployments show a 4pt gap vs Cerner; deeper dive recommended on Epic-specific FHIR latency.", reply: "" },
  },
  {
    id: "today-3",
    title: "Cerner expansion — security review next steps",
    time: new Date(Date.now() - 14400000).toISOString(),
    savedTurn: { query: "Drafted three talking points for the Cerner InfoSec call · attached SOC 2 packet · suggested legal bring HIPAA BAA addendum.", reply: "" },
  },
  {
    id: "yesterday-1",
    title: "Prototype · First-Handoff Wizard v2",
    time: new Date(Date.now() - 86400000).toISOString(),
    savedTurn: { query: "Design Agent iterated 3 directions for the inline 3-step prompt. Direction B (split-screen) won internal review.", reply: "" },
  },
  {
    id: "yesterday-2",
    title: "Veradigm integration scoping",
    time: new Date(Date.now() - 100000000).toISOString(),
    savedTurn: { query: "PM Agent compared FHIR coverage across Veradigm, Epic, and Cerner. Veradigm scope is roughly 60% smaller. PRD generated.", reply: "" },
  },
  {
    id: "week-1",
    title: "Shift-handoff drop · root-cause investigation",
    time: new Date(Date.now() - 172800000).toISOString(),
    savedTurn: { query: "Resolved · was a deploy-time config regression. Engineer Agent caught it. Full RCA in thread.", reply: "" },
  },
  {
    id: "week-2",
    title: "Q3 OKR mid-quarter review · prep doc",
    time: new Date(Date.now() - 259200000).toISOString(),
    savedTurn: { query: "Drafted the mid-quarter narrative — 2 of 3 OKRs on track, retention OKR at risk (now flagged this week).", reply: "" },
  },
  {
    id: "earlier-1",
    title: "Onboarding redesign · prototype",
    time: new Date(Date.now() - 604800000).toISOString(),
    savedTurn: { query: "Design Agent prototyped a 5-step new-deployment onboarding. Tested with 3 customers. Direction approved.", reply: "" },
  },
]
