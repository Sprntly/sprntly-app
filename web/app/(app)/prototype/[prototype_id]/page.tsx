...
// resolver reads NavigationContext.canvasPrototypeId — so a refresh on
// /prototype/<id> re-opens the canvas. This shell exists so the dynamic route
// BUILDS and so something renders behind the canvas overlay.
//
...
// /prototype/<id> on the static host on a REAL hard-refresh relies on a
// deploy-side SPA-fallback rewrite (/prototype/* → this shell) — same class as
// the open /p/* rewrite. Until that lands, a hard-refresh 404s; this is KNOWN
// and flag-gated (NEXT_PUBLIC_DESIGN_AGENT_ENABLED=0), not a bug.
