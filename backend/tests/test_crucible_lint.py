...
@pytest.mark.parametrize("text", [
    ...
    "Slow export is why accounts churn.",
    "Slow export contributes to churn.",
    "The root cause of the drop is the pricing change.",
])
def test_head_noun_causal_assertions_are_blocked(text):
    """"The cause of X is Y" is a full causal claim. An LLM writing findings
    reaches for it at least as often as for "causes"."""
