...
def figma_authorize(sprintly_session: Annotated[str | None, Cookie()] = None):
    require_session(sprintly_session)
...
@router.delete("/figma")
def figma_disconnect(sprintly_session: Annotated[str | None, Cookie()] = None):
    require_session(sprintly_session)
...
def github_authorize(sprintly_session: Annotated[str | None, Cookie()] = None):
    require_session(sprintly_session)
...
def github_disconnect(sprintly_session: Annotated[str | None, Cookie()] = None):
    require_session(sprintly_session)
