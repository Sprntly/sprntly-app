...
async def lifespan(app: FastAPI):
    ...
    # Design Agent startup invalidation (P1-07 prototypes).
    #
    ...
    # the P1 rollup until this landed). On main only the P1-07 prototypes block
    # exists; the P3-06 iterations call lives on the release branch (its both-calls
    # guard at fix/design-agent/lifespan-guard-both-calls rides the P3 rollup).
    try:
