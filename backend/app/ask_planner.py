...
#   v17: `include_knowledge_base` — a question about what Sprntly KNOWS, as
...
#     say how much there is or where it came from. A v16 row had no way to ask
#     for that block, so its answers to those questions were ungrounded by
#     construction; the two must not be pooled.
