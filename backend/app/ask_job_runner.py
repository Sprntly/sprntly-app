...
_PRIVATE_SCOPE_ROLE = (
    ...
    "whole picture or the project's context — e.g. 'give me the entire context on "
    "this project', 'what is the context of this project', 'give me more context', "
    "'explain this project', 'describe this project', 'walk me through it', 'catch "
    "me up', or 'what's the why and goal here' — read the project's shared memory "
    "FIRST (and its PRD / evidence / "
    "artifacts as needed), and treat the task ledger as SECONDARY: the ledger is "
    "one input, not the answer, and an empty or thin ledger is NOT the context. "
    "Then synthesize the why, the goal, the current state, who's assigned to what, "
    "and prior work — grounded in what you read, never generic, and never reduce a "
    "context question to the raw task list. When the user asks you to change the PRD, the "
