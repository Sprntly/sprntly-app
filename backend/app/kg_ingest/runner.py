...
PULLERS: dict[str, tuple[Callable[[str], Iterable[RawRecord]], str, str]] = {
    ...
    "gong":      (gong.pull,      "basic_token",  "customer_voice (sales & customer-success call recordings — Gong's distilled call briefs, key points, highlights: first-party voice-of-customer evidence from real customer conversations)"),
