...
- **Inputs from Sprntly:** the ranked opportunity + confidence from the Top Insights, supporting signals across sources (for "why now"), and outcome-graph estimates (for expected impact).
